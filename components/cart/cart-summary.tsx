  ...
  return (
    <div className="border border-slate-200 rounded-2xl p-6 md:p-8 sticky top-24 bg-white shadow-sm">
      ...
      <div className="space-y-3 mb-10">
        {SHIPPING_OPTIONS.map((option) => (
          <label 
            ...
            className={cn(
              "flex items-center justify-between p-4 border rounded-xl cursor-pointer transition-all duration-200 group relative",
      ...
      <p className="text-center text-xs text-slate-400 mt-6 px-4">
        Secure checkout powered by Nayzak. All rights reserved.
      </p>
    </div>
  );
};
